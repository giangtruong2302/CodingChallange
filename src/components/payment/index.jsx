        ...
        <div className="flex flex-col h-screen bg-slate-100">
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-col bg-white' >
              <div className='flex flex-row justify-between pl-4 pr-4 pt-4 pb-4  border-b-slate-100 border-b-2 border-b-solid h-max justify-items-center' onClick={() => { setPayWithVisa(true) }}>
              ...
              <div className='flex flex-row justify-between  border-b-slate-100 border-b-2 border-b-solid pl-4 pr-4 pt-4 pb-4' onClick={() => { setPayWithVisa(false) }}>
                <div className="flex flex-row gap-3.5">
